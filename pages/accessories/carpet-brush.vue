            ...
            <div class="w-[55%] min-h-screen max-h-screen h-screen sticky top-0">
                <div class="h-full w-full relative">
                    <div class="h-full w-full grid place-content-center">
                        <img src="@/assets/products/static/accessories/carpet-brush.png" class="h-96 " alt="" />
                    </div>
        ...
        <div class="lg:hidden relative bg-white">
            ...
            <div class="h-[60vh] pt-[10vh] w-full">
                <div class="h-[50vh] w-full flex items-center justify-center">
                    <img src="@/assets/products/static/accessories/carpet-brush.png" class="h-[60vw]" alt="">
                </div>
...
const productName = ref('Carpet Brush')
const productminiDescription = ref('Brush')
const description = ref('Introducing the Carpet Brush Without Wheels, a cutting-edge cleaning accessory that provides exceptional carpet cleaning without the need for wheels. This brush attachment effortlessly agitates and lifts dirt, dust, and debris from your carpets, ensuring a thorough and rejuvenating clean. Experience efficient and hassle-free carpet cleaning with this innovative brush attachment.')
useHead({
