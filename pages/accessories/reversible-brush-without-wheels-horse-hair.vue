            ...
            <div class="w-[55%] min-h-screen max-h-screen h-screen sticky top-0">
                <div class="h-full w-full relative">
                    <div class="h-full w-full grid place-content-center">
                        <img src="@/assets/products/static/accessories/reversible-brush-without-wheels-horse-hair.png"
                            class="h-96 " alt="" />
                    </div>
...
const productName = ref('Reversible Brush')
const productminiDescription = ref('Without wheels - Horse Hair')
const description = ref('Introducing the Reversible Brush Without Wheels - Horse Hair, a versatile and efficient cleaning tool for all your floor surfaces. This reversible brush attachment, made with high-quality horse hair, gently sweeps away dust and debris from both hard floors and carpets, leaving them looking fresh and clean. Upgrade your cleaning routine with this reversible brush for hassle-free and effective floor cleaning.')
useHead({
