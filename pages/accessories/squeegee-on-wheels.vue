            ...
            <div class="w-[55%] min-h-screen max-h-screen h-screen sticky top-0">
                <div class="h-full w-full relative">
                    <div class="h-full w-full grid place-content-center">
                        <img src="@/assets/products/static/accessories/squeegee-on-wheels.png" class="h-96 " alt="" />
                    </div>
            ...
            <div class="w-[45%] min-h-screen flex text-black flex-col">
                ...
                <div class="px-10 mt-2 2xl:px-20">
                    ...
                    <div
                        ...
                        <h3 class="text-sm 2xl:text-lg">NA</h3>
        ...
        <div class="lg:hidden relative bg-white">
            ...
            <div class="h-[60vh] pt-[10vh] w-full">
                <div class="h-[50vh] w-full flex items-center justify-center">
                    <img src="@/assets/products/static/accessories/squeegee-on-wheels.png" class="h-[60vw]" alt="">
                </div>
...
const productName = ref('Squeegee')
const productminiDescription = ref('On Wheels')
const description = ref('Introducing the Squeegee-on-Wheels, a game-changing cleaning tool for effortless and streak-free window cleaning. With its innovative design featuring built-in wheels, this squeegee glides smoothly across glass surfaces, eliminating the need for manual pushing or lifting. Achieve sparkling, crystal-clear windows with ease using the convenience of the Squeegee-on-Wheels.')
useHead({
