                ...
                <div class="h-full w-full relative">
                    ...
                    <div class="h-full w-full absolute top-0 flex flex-col justify-between">
                        <div
                            ...
                            <NuxtLink to="/"><img src="@/assets/images/logo.svg"
...
const productName = ref('Kick Vac')
...
suck away floor sweepings. Conveniently 
placed in the kitchen, requires no setup 
or put away time. Kickvac makes your life 
easier by reducing manual cleaning 
process. simply dispose of your floor 
sweeping in 3 seconds flat
`)
useHead({
