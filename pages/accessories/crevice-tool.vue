            ...
            <div class="w-[55%] min-h-screen max-h-screen h-screen sticky top-0">
                <div class="h-full w-full relative">
                    <div class="h-full w-full grid place-content-center">
                        <img src="@/assets/products/static/accessories/crevice.png" class="h-96 " alt="" />
                    </div>
        ...
        <div class="lg:hidden relative bg-white">
            ...
            <div class="h-[60vh] pt-[10vh] w-full">
                <div class="h-[50vh] w-full flex items-center justify-center">
                    <img src="@/assets/products/static/accessories/crevice.png" class="h-[60vw]" alt="">
                </div>
...
const productName = ref('Crevice')
const productminiDescription = ref('Tool')
const description = ref('Introducing the Crevice Tool, a versatile cleaning accessory designed to reach narrow and hard-to-reach spaces with ease. With its slender and elongated design, this crevice tool effortlessly extracts dust, dirt, and debris from tight corners, crevices, and gaps, ensuring a thorough and precise cleaning experience. Tackle every nook and cranny with the precision and efficiency of the Crevice Tool.')
useHead({
