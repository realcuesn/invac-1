            ...
            <div class="w-[55%] min-h-screen max-h-screen h-screen sticky top-0">
                <div class="h-full w-full relative">
                    <div class="h-full w-full grid place-content-center">
                        <img src="@/assets/products/static/accessories/delicate-dust.png" class="h-96 " alt="" />
                    </div>
        ...
        <div class="lg:hidden relative bg-white">
            ...
            <div class="h-[60vh] pt-[10vh] w-full">
                <div class="h-[50vh] w-full flex items-center justify-center">
                    <img src="@/assets/products/static/accessories/delicate-dust.png" class="h-[60vw]" alt="">
                </div>
...
const productName = ref('Delicate Dust')
const productminiDescription = ref('Brush')
const description = ref('Introducing the Delicate Dust Brush, a gentle yet effective cleaning tool designed for delicate surfaces. With its soft bristles and meticulous craftsmanship, this dust brush delicately removes dust and debris from sensitive items like electronics, delicate furniture, and collectibles. Safely clean your valuables with the precision and care of the Delicate Dust Brush.')
useHead({
