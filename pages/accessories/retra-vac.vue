        ...
        <div class="hidden bg-white lg:flex">
            <div class="w-[55%] min-h-screen max-h-screen h-screen sticky top-0">
                <div class="h-full w-full relative">
                    <img src="@/assets/images/home-static/retra-vac.png" class="h-full w-full object-cover " alt="" />
...
hose, cleaning up after a party gets done 
in a Jiffy simply by pulling out the hose, 
suck the mess out and let the hose 
